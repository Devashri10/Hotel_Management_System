...
class Support_win:
    def __init__(self,root):    #__init__ for construction calling & root is window 
        ...
        img1=Image.open(r"C:\python\New Project\Hotel_images\help_desk.jpg")
        ...
        img3=Image.open(r"C:\python\New Project\Hotel_images\Report.png")
        ...
        lbl_Help=Label(main_frame,text="bhosaledevashri1042@gmail.com",font=("times new roman",20,"bold"),fg="black",bg="White",bd=4,relief=RIDGE)
