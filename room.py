...
class Roombooking:
    def __init__(self,root): #__init__ for construction calling & root is window 
        ...
        img2=Image.open(r"C:\python\New Project\Hotel_images\Hotel_Logo.jpg")  # r is to convert single slash into double back slash
        ...
        conn=mysql.connector.connect(user="root",password="1042$Devashri",host="localhost",database="management",port="3306")
        cur=conn.cursor()
        ...
        #***************** RightSide Image**************
        img3=Image.open(r"C:\python\New Project\Hotel_images\bed.jpg")  # r is to convert single slash into double back slash
